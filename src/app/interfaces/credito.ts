export interface Credito {
  ...
  fechaAsignacionCalificacionSBS?: number;
  fechaAsignacionCalificacionSBSManual?: number;
  fechaCancelacionCuentaCredito?: number;
  fechaInsercionDeRegistro?: number;
  fechaPrimerVencimiento?: number;
  fechaUltimaLiquidacionIntereses?: number;
  fechaUltimaModificacionRegistro?: number;
  fechaUltimoPago?: number;
  fechaUltimoPagoInteres?: number;
  fechaUltimoPagoPrincipal?: number;
