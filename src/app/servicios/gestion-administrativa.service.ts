...
export class GestionAdministrativaService {
  ...
  leerAccionPorTarea(accionId: any): Observable<Respuesta> {
    return this.http.put<Respuesta>(`${urlBase}/leer-accion-por-id`, {}, {params: new HttpParams().set('accionId', accionId)});
  }
}
