...
export class MyCurrencyDirective implements OnInit {
  ...
  ngOnInit() {
    this.el.value = this.formatcurrencypipe.transform(this.el.value, CONST.C_INT_CANTIDAD_NUMEROS_DECIMALES);
  }
  ...
  onBlur(value) {
    this.el.value = this.formatcurrencypipe.transform(value, CONST.C_INT_CANTIDAD_NUMEROS_DECIMALES);
  }
