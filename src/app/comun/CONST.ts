export class CONST {
  ...
  public static TABLE_STR_LISTA_TIPO_CONDICIONES_SOLICITUD = '41';
  public static TABLE_STR_LISTA_ARCIVOS_CHEkLIST = '42';
  ...
  public static C_STR_TIPO_DOCUMENTO_DNI = 'D';
